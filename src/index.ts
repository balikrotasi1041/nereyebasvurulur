...
const CONTENT_CACHE_REVISION = "announcement-guide-relations-2026-09-20";
...
function edgeCacheKey(url: URL): Request {
  ...
  if (url.pathname.startsWith("/konu/") || url.pathname.startsWith("/askerlik-subeleri/")) {
    keyUrl.searchParams.set("__content_revision", CONTENT_CACHE_REVISION);
  }
